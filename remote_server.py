...
# Create a keyboard object using controller
    ...
    while True:
        try:
            ...
            # Check if message is received
                ...
                # USe press method and pass the key present in the message variable to press a key
                
                # Call release with message to release the key
